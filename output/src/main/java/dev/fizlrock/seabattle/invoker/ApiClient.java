...
package dev.fizlrock.seabattle.invoker;
...
import dev.fizlrock.seabattle.invoker.auth.HttpBasicAuth;
import dev.fizlrock.seabattle.invoker.auth.HttpBearerAuth;
import dev.fizlrock.seabattle.invoker.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      } else if ("basicHttpAuthentication".equals(authName)) {
